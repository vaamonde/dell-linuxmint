...
A FALHA FOI RESOLVIDA UTILIZANDO O SOFTWARE **RUFUS** NO MICROSOFT WINDOWS, MAIS NA VERSÃO DO *LINUX MINT 21.x* A INICIALIZAÇÃO NORMAL NÃO APARECE A TELA GRÁFICA DO LINUX MINT, SENDO NECESSÁRIO SELECIONAR A OPÇÃO **MODO DE COMPATIBILIDADE** QUE É RECOMENDADO PARA EQUIPAMENTOS LEGADOS.
...
07) Edite o arquivo do GRUB digitando o comando: **vim /etc/default/grub** <Enter><br>
    INSERT<br>
    #alterar as configurações padrão do linux linha 10: <br>
