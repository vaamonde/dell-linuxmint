...
#04_ Inicialização da Instalação do Linux Mint 20.1 Ulyssa, 20.2 Uma, 20.3 Una, 21 Vanessa ou 21.1 Vera<br>
	...
	O GRAVADOR DE IMAGEM USB COM A ISSO OFICIAL DO LINUX MINT 21.1 VERA x64 A MENSAGEM DE ERRO:
	OPERATION SYSTEM NOT FOUND E MOSTRADA, ISSO NO ACONTECE NA VERSÃO 20.x, CONFORME RELATOS NO 
	FÓRUM DO LINUX MINT O ERRO ESTÁ ASSOCIADO A ALGUM DISCO FORMATADO COM GPT (GUID Partition 
	Table) UTILIZADO EM SISTEMA UEFI (Unified Extensible Firmware Interface), TESTES FEITO COM 
	VÁRIOS SOFTWARE DE GRAVAÇÃO DE IMAGEM USB ACONTECEU O MESMO ERRO.
