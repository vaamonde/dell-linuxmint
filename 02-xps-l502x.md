...
#Data de atualização: 26/09/2023<br>
#Versão: 0.26<br>
...
#04_ Inicialização da Instalação do Linux Mint 20.1 Ulyssa, 20.2 Uma, 20.3 Una, 21 Vanessa, 21.1 Vera e 21.2 Victoria x64<br>
	...
	(GUID Partition Table) UTILIZADO EM SISTEMAS UEFI (Unified Extensible Firmware Interface), 
	...
	_08 selecione novamente a sua partição Ext4 e clique em: Instalar agora
	_09 na tela de: Go back to the menu and resume partitioning clique em: Continuar
	...
	_07 edite o arquivo do GRUB digitando o comando: vim /etc/default/grub <Enter>
		INSERT
			#alterar a linha: GRUB_CMDLINE_LINUX_DEFAULT="quiet splash"
	...
	OBSERVAÇÃO IMPORTANTE: O Linux Mint 21.1 Victoria tem a mesma falha de inicialização e
