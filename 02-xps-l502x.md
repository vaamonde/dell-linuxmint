...
#04_ Inicialização da Instalação do Linux Mint 20.1 Ulyssa, 20.2 Uma, 20.3 Una, 21 Vanessa ou 21.1 Vera<br>
	...
	OPERATION SYSTEM NOT FOUND É MOSTRADA, ISSO NÃO ACONTECE NA VERSÃO 20.x, CONFORME RELATOS 
	...
	TESTES FEITO COM VÁRIOS SOFTWARE DE GRAVAÇÃO DE IMAGEM USB ACONTECEU O MESMO ERRO.

	A FALHA FOI RESOLVIDA UTILIZANDO O SOFTWARE RUFUS NO MICROSOFT WINDOWS, MAIS NA VERSÃO DO
	LINUX MINT 21.1 A INICIALIZANDO NORMAL NÃO APARECE A TELA, SENDO NECESSÁRIO SELECIONAR A
	OPÇÃO MODO DE COMPATIBILIDADE QUE É RECOMENDADO PARA EQUIPAMENTOS LEGADOS.
