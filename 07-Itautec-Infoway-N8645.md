...
#07_ Pós-Instalação do Linux Mint 20.x, 21.x ou 22.x no Notebook Itautec Infoway N8645<br>
```bash
...
#08_ Instalação do Linux Kernel OEM (Original Equipment Manufacturer) no Notebook Itautec Infoway N8645 <br>
```bash
...
#10_ Instalação dos Drivers VGA Intel Graphics e AMD Radeon do Linux Mint no Notebook Itautec Infoway N8645<br>
```bash
