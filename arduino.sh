...
# qual tem origem em Wiring, e é essencialmente C/C++.
#
# Arduino Integrated Development Environment IDE é uma aplicação de plataforma cruzada, escrito em funções 
# de C e C ++. É usado para escrever e fazer upload de programas em placas compatíveis com Arduino, mas também, 
# com a ajuda de núcleos de terceiros, outras placas de desenvolvimento de fornecedores.
#
# O BlocklyDuino é um editor de programação visual baseado na web para Arduino. BlocklyDuino é baseado no Blockly, 
# o editor de programação gráfica baseado na web. Fornece blocos de linguagem de tipo estático e geradores de
# código para programação em Arduino. O BlocklyDuino também oferece suporte aos blocos Grove para iniciar facilmente
# a experimentação e o aprendizado baseados em microcontroladores.
#
# O Fritzing é uma iniciativa de código aberto para desenvolver um software tipo CAD amador para design de hardware 
# eletrônico, para apoiar designers e artistas prontos para deixar de experimentar um protótipo e construir um 
# circuito mais permanente com uma Placa de Circuito Impresso. 
#
# Site Oficial do Arduino IDE: https://www.arduino.cc/
# Site Oficial do BlockDuino IDE Plugin: https://github.com/BlocklyDuino/BlocklyDuino_IDE_plugin
...
#
# Script de instalação do Arduino IDE, BlocklyDuino e do Fritzing no Linux Mint 20.1 Ulyssa
...
#
echo
echo -e "Instalação do Arduino IDE, BlocklyDuino e do Fritzing no Linux Mint 20.1 Ulyssa\n"
...
echo
#
echo -e "Descompactando o Arduino IDE no diretório: /opt/, aguarde..."
	# opção do redirecionador &>>: Redireciona a saída padrão (STDOUT) anexando
