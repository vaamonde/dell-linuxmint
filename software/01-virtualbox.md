...
#OBSERVAÇÃO IMPORTANTE: para aplicar as mudanças no GRUB e necessário reiniciar o sistema operacional
#e checar novamente se a correção funcionou.
sudo reboot
...
#COMANDO SEM ANTES VERIFICAR O MOTIVO DA FALHA.
...
#preparando o processo de compilação dos módulos do Kernel
