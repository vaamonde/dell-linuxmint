...
#Data de criação: 08/10/2025<br>
#Data de atualização: 08/10/2025<br>
#Versão: 0.01<br>
#Testado e homologado no Linux Mint 22.2 Zara x64 Bits
...
#01_ Download da ISO do Linux Mint 22.2 x64<br>
...
[![Linux Mint 22.2](http://img.youtube.com/vi/NN3VOFyWKsM/0.jpg)](https://www.youtube.com/watch?v=NN3VOFyWKsM "Linux Mint 22.2")
...
## Instalação do Linux Mint 22.2 x64 Bits no Oracle VirtualBOX

### Primeira etapa: Download da ISO do Linux Mint 22.2 x64

Link de download do Linux Mint 22.1 "Zara" Cinnamon 64 Bits
  ...
  Selecione: Ferramentas
    Clique em: <Novo>
      01) Nome da máquina virtual e Sistema Operacional:
        Nome: LinuxMint22.2 (altere conforme sua necessidade)
...
No Oracle VirtualBOX
  Selecione a Máquina Virtual: LinuxMint22.2
  ...
  Selecione a Máquina Virtual: LinuxMint22.2
    Clique em: <Iniciar (T)>
      Na tela de: VirtualBoxVM
        ...
        Selecione a ISO do: Linux Mint 22.2 - Clique em: <Abrir (O)>
...
Na tela inicial do Boot Load GRUB do Linux Mint
  Welcome to Linux Mint 22.2 64-Bit
    *Start Linux Mint 22.2 Cinnamon 64-Bit (Padrão)
...
Na tela inicial do Boot Load GRUB do Linux Mint
  Welcome to Linux Mint 22.2 64-Bit
    *Start Linux Mint 22.2 Cinnamon 64-Bit (Padrão) <Enter>
```
