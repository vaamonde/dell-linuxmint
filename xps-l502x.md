...
#04_ Hard Disk SATA SSD 240 e 500GB<br>
	...
	_ Modelo Corsair Force GT3, Hard Disk para a instalação do Linux Mint, sem necessidade de particionamento 
	_ (instalação padrão), HD Seagate 500GB 7200rpm usado para armazenamento de arquivos e backup (case Akasa AK-OA2SSA-BKV2 2,5").
