...
#Data de atualização: 24/09/2023<br>
#Versão: 0.25<br>
...
#07_ Pós-Instalação do Linux Mint 20.1 Ulyssa, 20.2 Uma, 20.3 Una, 21 Vanessa, 21.1 Vera e 21.2 Victoria x64<br>
...
#10_ Instalação dos Drives da NVIDIA, CUDA, Vulkan e Intel Graphics<br>
	...
	_ Recomendado utilizar o Gerenciador de Drives do Linux Mint (ou por linha de comando, não recomendado)
		...
		_ nvidia-driver-535 (funcionando perfeitamente, testado no dia: 24/09/2023)
