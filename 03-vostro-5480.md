...
#Data de atualização: 05/07/2021<br>
#Versão: 0.09<br>
...
#10_ Instalação dos Drives da NVIDIA, CUDA, Vulkan e Intel Graphics<br>
	...
	_ Recomendado utilizar o Gerenciador de Drives do Linux Mint (ou por linha de comando, não recomendado)
		...
		_ nvidia-driver-465 (recomendado)
...
#11_ Instalação do Leitor de Biometria (Fingerprint não é mais suportado no Ubuntu 20.04 ou superior<br>
